...
export type CoreTelemetryEventNames = {
	...
	'item/definition/createFile': { properties: ArtifactPropertyNames | 'fileExtension'; measurements: never },
	'item/definition/deleteFile': { properties: ArtifactPropertyNames; measurements: never },
	'item/definition/delete': { properties: ArtifactPropertyNames; measurements: never },
