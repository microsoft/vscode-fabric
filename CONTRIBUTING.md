...
Start every contribution by [opening an issue](https://github.com/microsoft/vscode-fabric-pr/issues/new); that conversation is where we agree on scope and approach before work begins. For larger or design-heavy proposals, consider drafting an RFC following the examples in [`docs/rfc/`](./docs/rfc).
