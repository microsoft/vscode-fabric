# Microsoft Fabric for Visual Studio Code (Preview)
...
Sign up for [Free Microsoft Fabric Trial capacity](https://learn.microsoft.com/fabric/get-started/fabric-trial#start-the-fabric-capacity-trial) and Microsoft Fabric is provided free of charge.  It includes access to the Fabric product workloads and the resources to create and host Fabric items. 
...
2. Create and open workspaces in you Fabric account.
2. View the items in your workspace and open in Fabric, rename and edit items. You can group them by item type or view them as a list. 
...
To sign in to your Fabric account,  is simple , simply press `F1` and type in `Fabric: Sign in` (or click on the `Sign in to Fabric...` node in the Fabric Explorer).
