...
**MICROSOFT FABRIC VS CODE (PREVIEW)**  
...
8. **SUPPORT SERVICES.** Microsoft is not obligated under this agreement to provide any support services for the software. Any support provided is ìas isî, ìwith all faultsî, and without warranty of any kind. 
