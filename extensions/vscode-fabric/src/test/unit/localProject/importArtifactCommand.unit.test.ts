...
import { IArtifact, IWorkspaceManager, IArtifactManager, IWorkspace, IFabricApiClient, IApiClientResponse } from '@fabric/vscode-fabric-api';
import { IItemDefinitionReader } from '../../../itemDefinition/ItemDefinitionReader';
import { IFabricEnvironmentProvider, FabricError, TelemetryActivity, UserCancelledError } from '@fabric/vscode-fabric-util';
