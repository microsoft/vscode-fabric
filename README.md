...
[![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](https://github.com/microsoft/vscode-fabric-pr/blob/main/LICENSE.txt)
...
Have an idea, question, or bug report? [Open a new issue](https://github.com/microsoft/vscode-fabric-pr/issues/new/choose) and select the template that best fits your scenario.
