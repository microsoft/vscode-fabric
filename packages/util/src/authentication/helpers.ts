...
type SignInRequestProperties = 'silent' | 'createIfNone' | 'clearSessionPreference' | 'forceNewSession';
type EventsWithAllSignInRequestProperties = EventsWithAllProperties<TelemetryEventNames, SignInRequestProperties>;
export function addSignInRequestInfoToActivity(event: TelemetryEvent<TelemetryEventNames, EventsWithAllSignInRequestProperties>, options: vscode.AuthenticationGetSessionOptions) {
...
export function addAccountInfoToEvent(activity: TelemetryEvent<TelemetryEventNames, EventsWithAllSignedInRequestProperties>, account: vscode.AuthenticationSessionAccountInformation | null) {
...
export function addEnvironmentInfoToEvent(event: TelemetryEvent<TelemetryEventNames, EventsWithEnvironmentTypeProperty>) {
